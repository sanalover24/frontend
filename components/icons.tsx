...
export const BarChart3Icon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M3 3v18h18"/><path d="M18 18V9"/><path d="M13 18V3"/><path d="M8 18v-6"/>
    </svg>
);
export const WalletIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M19 7V4a1 1 0 0 0-1-1H5a2 2 0 0 0 0 4h15a1 1 0 0 1 1 1v4h-3a2 2 0 0 0 0 4h3a1 1 0 0 0 1-1v-2a1 1 0 0 0-1-1" /><path d="M3 5v14a2 2 0 0 0 2 2h15" />
    </svg>
);
...
export const ArrowUpRightIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M7 17V7h10" /><path d="M7 7 17 17" />
    </svg>
);
...
export const GoogleIcon: React.FC<IconProps> = ({ className }) => (
    <svg aria-hidden="true" className={className} width="18" height="18" viewBox="0 0 18 18">
        ...
        <path d="M9 18C11.43 18 13.4673 17.1941 14.9564 15.8195L12.0477 13.5614C11.2418 14.1014 10.2109 14.4205 9 14.4205C6.96182 14.4205 5.23727 13.0273 4.62364 11.1614H1.59909V13.4836C3.07818 16.2227 5.79545 18 9 18Z" fill="#34A853"></path>
        <path d="M4.62364 11.1614C4.41545 10.5659 4.29818 9.93182 4.29818 9.27273C4.29818 8.61364 4.41455 7.97955 4.62273 7.38409V5.06182H1.59909C0.947273 6.34773 0.531818 7.77273 0.531818 9.27273C0.531818 10.7727 0.947273 12.1977 1.59909 13.4836L4.62364 11.1614Z" fill="#FBBC05"></path>
        <path d="M9 4.125C10.3218 4.125 11.5073 4.58727 12.4782 5.50909L15.0355 2.95227C13.4673 1.47273 11.43 0.545455 9 0.545455C5.79545 0.545455 3.07818 2.32273 1.59909 5.06182L4.62273 7.38409C5.23636 5.51818 6.96182 4.125 9 4.125Z" fill="#EA4335"></path>
    </svg>
);
